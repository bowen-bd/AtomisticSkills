...
mcp_drugdisc_compute_molecular_fingerprints(
    smiles_file="skills/drug-molecular-fingerprints/examples/nsaids.smi",
    radius=2,
    fp_size=2048,
    cluster=True,
    cluster_cutoff=0.4,
    save_heatmap="skills/drug-molecular-fingerprints/examples/nsaid_similarity.png",
    output_file="skills/drug-molecular-fingerprints/examples/nsaid_similarity.json"
)
```
