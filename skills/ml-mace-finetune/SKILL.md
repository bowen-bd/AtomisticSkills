...
conda run -n mace-agent python skills/ml-mace-finetune/scripts/generate_mace_config.py \
...
conda run -n base-agent python skills/ml-mace-finetune/scripts/extract_mace_logs.py \
