...
This directory contains a complete, self-contained example demonstrating how to use the `skills/ml-property-predictor/scripts/train_matgl_property.py` script to fine-tune a PyTorch Lightning-based MatGL MEGNet model to predict materials' **bulk modulus** (an intensive property).
