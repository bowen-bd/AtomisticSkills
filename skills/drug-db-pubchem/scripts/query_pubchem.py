...
Usage:
    python skills/db-pubchem/scripts/query_pubchem.py --name "aspirin" --output aspirin.json
    python skills/db-pubchem/scripts/query_pubchem.py --smiles "CC(=O)Oc1ccccc1C(=O)O" --output aspirin.json
    python skills/db-pubchem/scripts/query_pubchem.py --cid 2244 --output cid_2244.json
    python skills/db-pubchem/scripts/query_pubchem.py --formula "C9H8O4" --max_results 10 --output formula.json
