...
python skills/drug-pocket-detection/scripts/detect_pockets.py \
  ...
  --backend fpocket \
  --top_n 5 \
  --output_json skills/drug-pocket-detection/examples/hiv1-protease/pockets_fpocket.json
```
...
python skills/drug-pocket-detection/scripts/visualize_pockets.py \
  ...
  --top_n 3 \
  --output skills/drug-pocket-detection/examples/hiv1-protease/pockets_visualization.png
```
...
python skills/drug-pocket-detection/scripts/pocket_to_box.py \
  ...
  --padding 6.0 \
  --min_size 20.0 \
  --output_json skills/drug-pocket-detection/examples/hiv1-protease/binding_site_from_pocket.json
```
