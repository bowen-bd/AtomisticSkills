...
# Target directory
EX_DIR="skills/ml-fairchem-finetune/examples/fairchem-wbm-finetune"
OUT_DIR="$EX_DIR"
...
conda run -n fairchem-agent python skills/ml-fairchem-finetune/scripts/generate_fairchem_config.py \
