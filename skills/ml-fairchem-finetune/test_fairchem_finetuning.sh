...
conda run --live-stream -n fairchem-agent python skills/ml-fairchem-finetune/scripts/prepare_fairchem_data.py \
...
conda run --live-stream -n fairchem-agent python skills/ml-fairchem-finetune/scripts/extract_fairchem_logs.py \
