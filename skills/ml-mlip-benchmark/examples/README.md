...
```bash
# Env: base-agent
conda run -n base-agent python skills/ml-mlip-benchmark/examples/fetch_r2scan.py
```
...
conda run -n matgl-agent python skills/ml-mlip-benchmark/scripts/run_benchmark.py \
