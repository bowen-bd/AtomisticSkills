...
```bash
python skills/mat-phase-field-conservative/scripts/run_spinodal_decomposition.py \
    --grid-size 100 \
    --dx 0.25 \
    --steps 200 \
    --dt 0.01 \
    --output skills/mat-phase-field-conservative/examples/benchmark-spinodal/classic_spinodal.gif
```
