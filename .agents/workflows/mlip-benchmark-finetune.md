...
1. **Choose a relevant foundation potential**
   ...
   - Refer to the `ml-foundation-potentials` skill (`skills/ml-foundation-potentials/SKILL.md`) to select an appropriate foundation potential.
...
2. **Sample the Potential Energy Surface (PES)**
   ...
   - For solid-state materials, refer to the `mat-sample-pes-by-md` skill (`skills/mat-sample-pes-by-md/SKILL.md`).
...
4. **Benchmark the foundation potential's accuracy**
   ...
   - Refer to the `ml-mlip-benchmark` skill (`skills/ml-mlip-benchmark/SKILL.md`) for benchmarking procedures to determine if fine-tuning is necessary.
